...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _validate_ship_placement__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./validate-ship-placement */ \"./src/validate-ship-placement.js\");\n\n\nconst placeShip = (gameboard, ship, row, col, orientation) => {\n  if ((0,_validate_ship_placement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(gameboard, row, col, ship.length, orientation)) {\n    gameboard.placeShip(ship, row, col, orientation);\n    return true;\n  }\n  return false;\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (placeShip);\n\n\n//# sourceURL=webpack://template/./src/place-ship.js?");
